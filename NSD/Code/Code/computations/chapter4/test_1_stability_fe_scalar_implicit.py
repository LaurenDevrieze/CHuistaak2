...
#fe = integrators.implicit_euler_integrator.ImplicitEulerIntegrator(ode,solver)
fe = integrators.trapezium_integrator.TrapeziumIntegrator(ode,solver)
...
#plt.savefig('implicit_test.pdf')
plt.savefig('trapezium_test.pdf')
